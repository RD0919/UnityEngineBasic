...
public class Seek : Node
{
    ...
    public override Status Invoke()
    {
        ...
        {
            ray = new Ray(blackboard.transform.position + _offset, Quaternion.Euler(Vector3.up * theta) * blackboard.transform.forward);
            ...
            ray = new Ray(blackboard.transform.position + _offset, Quaternion.Euler(Vector3.down * theta) * blackboard.transform.forward);
