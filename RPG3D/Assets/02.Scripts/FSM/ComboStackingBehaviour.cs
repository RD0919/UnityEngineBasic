...
public class ComboStackingBehaviour : StateMachineBehaviour
{
    private BehaviourManager _manager;
    [SerializeField] private string _comboStackParamNane;
    ...
    {
        _manager= manager;
        _comboStackParamID = Animator.StringToHash(_comboStackParamNane);
