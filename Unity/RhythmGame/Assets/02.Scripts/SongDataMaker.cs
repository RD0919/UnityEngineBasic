...
namespace RhythmGame
{
    ...
    {
        private KeyCode[] _keys = { KeyCode.A, KeyCode.S, KeyCode.D, KeyCode.F, KeyCode.H, KeyCode.J, KeyCode.K, KeyCode.L };
        ...
        public void StopRecord()
        {
            ...
            System.IO.File.WriteAllText(dir, JsonUtility.ToJson(_songData));//중요
            _songData = null;
        }
