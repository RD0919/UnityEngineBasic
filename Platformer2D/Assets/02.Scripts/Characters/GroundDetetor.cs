...
public class GroundDetetor : MonoBehaviour
{
    ...
    {
        _detected = Physics2D.OverlapBox(point: (Vector2)transform.position + _castOffset, size: _castSize, angle: 0.0f, layerMask: _groundMask);
